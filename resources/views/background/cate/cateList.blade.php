...
@section('page-body')
    <div class="page-body">
        ...
        <button type="button" tooltip="添加用户" class="btn btn-sm btn-success btn-addon" onClick="javascript:window.location.href = '{{url('background/updateCate?act=add')}}'"> <i class="fa fa-plus"></i> Add
        </button>
        <div class="row">
