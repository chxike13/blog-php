...
@section('page-body')
    <div class="page-body">
        ...
        <button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '{{url('background/updateRole?act=add')}}'"> <i class="fa fa-plus"></i> Add
        </button>
        <div class="row">
